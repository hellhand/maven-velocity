...
public class VelocityProvider implements MessageBodyWriter<Object> {
    ...
    @Autowired
    @Qualifier(value = "velocityToolsConfiguration")
    private String velocityToolsConfiguration;
    ...
    public void postConstruct() throws VelocityException, IOException {
        ...
        velocityToolManager.configure(velocityToolsConfiguration);
    }
    ...
    public void writeTo(Object model, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
        ...
        try {
            ...
            context.put("screen_content", template.getData());

            Template layout = engine.getTemplate("layout.vm");
            layout.merge(context, writer);
